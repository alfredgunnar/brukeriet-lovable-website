        ...
        <Card className="max-w-md mx-auto bg-custom-cream/95 backdrop-blur-sm shadow-sm">
          <CardContent className="pt-6">
            ...
            <div className="mt-6 pt-4 border-t border-custom-terra/10 text-center">
              <p className="text-xs text-custom-brown">Vi har alltid öppet på vår instagram. Där postar vi vad som är aktuellt i butiken och nya möbler som kommer in. Skriv gärna till oss i DM på Instagram eller skicka ett mail till info@brukeriet.se så svarar vi så fort vi kan.</p>
